...
<body>
	...
	try {
		...
		String itemQuery = "SELECT * FROM item Where Auction_Leader=%?%";
		...
		out.print("Those are all our listed products containing: "+ request.getParameter("Search") + " in the Auction Leaders name");
