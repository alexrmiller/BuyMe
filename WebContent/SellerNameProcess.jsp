...
<body>
	...
	try {
		...
		String itemQuery = "SELECT * FROM item Where Seller_Username=%?%";
		...
		out.print("Those are all our listed products containing: "+ request.getParameter("Search") + " in the sellers name");
