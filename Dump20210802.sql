...
--
-- Host: 127.0.0.1    Database: my_1_schema
-- ------------------------------------------------------
...
CREATE TABLE `admin` (
  ...
  `complaints` varchar(500) DEFAULT 'used for displaying customer service reports',
...
INSERT INTO `admin` VALUES ('Soren','sorenmorici@gmail.com','gam170','Pizza is too cold');
...
CREATE TABLE `user` (
  ...
  `password` varchar(32) NOT NULL DEFAULT 'used for login',
  `email` varchar(255) DEFAULT 'used for contact',
  `Notifications` varchar(500) DEFAULT 'used for updating user',
...
INSERT INTO `user` VALUES ('Soren','gam170','sorenmorici@gmail.com','All good bud!','0123456789123456789','Barnegat, NJ');
...
-- Dump completed on 2021-08-02 22:37:09
