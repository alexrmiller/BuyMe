...
INSERT INTO `admin` VALUES ('Admin','admin@test.com','adminpassword',_binary ''),('Soren','sorenmorici@gmail.com','gam171',NULL);
...
CREATE TABLE `admincomplaints` (
  ...
  KEY `complaints_idx` (`adminusername`),
  KEY `complainer_idx` (`username`),
  CONSTRAINT `complainer` FOREIGN KEY (`username`) REFERENCES `user` (`username`),
  CONSTRAINT `complaints` FOREIGN KEY (`adminusername`) REFERENCES `admin` (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES ('Soren','gam170','sorenmorici@gmail.com','0123456789123456789','Barnegat, NJ'),('test','test','test@test.com','','');
...
INSERT INTO `usernotifications` VALUES (1,'this is a test notification','test'),(2,'another notification','test'),(3,'sorens notification','Soren');
...
-- Dump completed on 2021-08-09 15:39:11
