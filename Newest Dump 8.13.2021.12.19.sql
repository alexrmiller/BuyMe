...
CREATE TABLE `admincomplaints` (
  ...
  CONSTRAINT `complainer` FOREIGN KEY (`username`) REFERENCES `user` (`username`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `usernotifications` VALUES (4,NULL,NULL),(5,NULL,NULL),(6,NULL,NULL),(7,NULL,NULL);
...
-- Dump completed on 2021-08-13  0:19:49
